...
//b. creati o siungura metoda care sa primesa temperatura (numeric) si tipul de temperatura dort (string) si sa realizeze conversia necesera, apelati in main pt fiecare caz
    ...
    public static void main(String[] args) {
        ...
        System.out.println("------------------");
        System.out.println(" Temperature calculator with user input ");
        float cel, far, cels;
        ...
        System.out.println("Converted temperature in Fahrenheit is : " + far);
        System.out.println("------------------- ");
        System.out.println("Enter temp. in Fahrenheit : ");
        far = s.nextInt();
        cels = (far - 30) * 5 / 9;
        System.out.println("Converted temperature in Celsius is : " + cels);
